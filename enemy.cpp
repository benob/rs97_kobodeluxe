...
{
	enemies.make(&pipe2_, CS2PIXEL(x), CS2PIXEL(y), 0, 0, 3);
	enemies.make(&pipe2_, CS2PIXEL(x), CS2PIXEL(y), 0, 0, 7);
	enemies.make(&pipe2_, CS2PIXEL(x), CS2PIXEL(y), 0, 0, 1);
	enemies.make(&pipe2_, CS2PIXEL(x), CS2PIXEL(y), 0, 0, 5);
